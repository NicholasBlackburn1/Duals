...
public interface ArenaInterface {
    ...
    /**
     * Disables this arena which prevents it from being used in duels. Note: Calls
     * {@link ArenaStateChangeEvent}.
     *
     * @param source   {@link CommandSender} that will be the source of the
     *                 {@link ArenaStateChangeEvent} called. May be null!
     * @param disabled True to disable the arena, False to enable.
     * @return True if arena was disabled successfully. False if called
     *         {@link ArenaStateChangeEvent} was cancelled by a plugin.
     */
    boolean setDisabled(@Nullable final CommandSender source, final boolean disabled);

    /**
     * Calls {@link #setDisabled(CommandSender, boolean)} with the source being
     * null.
     *
     * @return True if arena was disabled successfully. False if called
     *         {@link ArenaStateChangeEvent} was cancelled by a plugin.
     ...
     * @return {@link Location} associated with the position number or null if
     *         position is unset.
     */
    @Nullable
    ...
    /**
     * Sets a spawnpoint with the given position and location. Note: Calls
     * {@link ArenaSetPositionEvent}.
     *
     * @param source   {@link Player} that will be the source of the
     *                 {@link ArenaSetPositionEvent} called. May be null!
     * @param pos      Position number for the spawnpoint.
     * @param location Location to be the spawnpoint. Should not be null!
     * @return True if the spawnpoint was set successfully. False if called
     *         {@link ArenaSetPositionEvent} was cancelled by a plugin.
     */
    ...
    /**
     * Whether or not a duel is currently being played in this arena. If returned
     * true, {@link #getMatch()} is guaranteed to return a {@link Match} instance.
     *
    ...
    /**
     * The {@link Match} being played in this arena. May be null if no match is
     * being played.
     *
     * @return {@link Match} instance if a duel is currently being played in this
    ...
    /**
     * Whether or not this {@link ArenaInterface} has been removed.
     *
     * @return True if this {@link ArenaInterface} has been removed. False
     *         otherwise.
