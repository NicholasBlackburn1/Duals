...
public interface KitInterface {
    ...
    /**
     * Whether or not this kit requires a permission. If usePermission is enabled,
     * players must have the permission 'duels.kit.[name] (space in name replaced to
     * dash)' to use the kit.
     *
    ...
    /**
     * Whether or not this kit has arenaSpecific enabled. If arenaSpecific is
     * enabled, only arenas with their name starting with this kit's name appended
     * with an underscore will be available when playing with this kit.
     *
    ...
    /**
     * Equips the {@link Player} with the contents of this kit. Note: Calls
     * {@link KitEquipEvent}.
     *
     * @param player {@link Player} to equip this kit.
     * @return True if {@link Player} has successfully equipped this kit. False
     *         otherwise.
     */
    boolean equip(@Nonnull final Player player);

    /**
     * Whether or not this {@link KitInterface} has been removed.
     *
     * @return True if this {@link KitInterface} has been removed. False otherwise.
